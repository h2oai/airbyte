...
from source_microsoft_sharepoint_h2o.spec import SourceMicrosoftSharePointSpec
from source_microsoft_sharepoint_h2o.stream_reader import (
    FileReadMode,
...
def setup_reader_class():
    ...
    with patch("source_microsoft_sharepoint_h2o.stream_reader.SourceMicrosoftSharePointClient") as mock_client_class:
...
def setup_client_class():
    ...
    with patch("source_microsoft_sharepoint_h2o.stream_reader.ConfidentialClientApplication") as mock_client_class:
...
@patch("source_microsoft_sharepoint_h2o.stream_reader.execute_query_with_retry")
@patch("source_microsoft_sharepoint_h2o.stream_reader.SourceMicrosoftSharePointStreamReader.filter_files_by_globs_and_start_date")
...
@patch("source_microsoft_sharepoint_h2o.stream_reader.SourceMicrosoftSharePointStreamReader._list_directories_and_files")
...
@patch("source_microsoft_sharepoint_h2o.stream_reader.execute_query_with_retry", side_effect=lambda x: x)
...
@patch("source_microsoft_sharepoint_h2o.stream_reader.requests.get")
@patch("source_microsoft_sharepoint_h2o.stream_reader.SourceMicrosoftSharePointStreamReader.get_access_token")
...
def test_drives_property(auth_type, user_principal_name, has_refresh_token):
    with patch("source_microsoft_sharepoint_h2o.stream_reader.execute_query_with_retry") as mock_execute_query, patch(
